...
To evaluate the computed assemblies the tool Quast is used. The script `S7_assemblyEvaluation.sh` is used as a wrapper for Quast and requires the definition of two parameters:
